...
import { TIMING } from '@/styles/animations'
...
export default function TableOfContents({ headings, loading = false }: TableOfContentsProps) {
  ...
  function scrollToHeading(headingId: string) {
    ...
    if (element) {
      const top =
        element.getBoundingClientRect().top + window.pageYOffset - ACTIVE_OFFSET + 20
